...
#in 2002
states_2002 <- states_observed |> filter(year == 2002) |>select(locationabbr,locations_count)
kable(states_2002, 
      caption  = "States that observed at 7 or more locations in 2002", 
      col.names = c( "State", "Locations Count"))
#in 2010
states_2010 <- states_observed |> filter(year == 2010) |>select(locationabbr,locations_count)
kable(states_2010, 
